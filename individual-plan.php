    ...
    <div class="page-header bg-section">
        <div class="container">
            ...
            <p class="mb-3 fs-6">Sign up now and enjoy <strong>upto 20% OFF</strong> on our Premium Membership Plan.</p>
             <a href="https://rzp.io/rzp/T1IPpCag" 
...
<section class="individual-plan py-5">
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 mb-4 mb-lg-0">
        <div class="plan-left p-4 h-100" 
          ...
          <h4 class="fw-bold" style="color:#b7c237;">Individual Plan</h4>
          <h5 class="mb-3">
            Exclusive Health Benefits only at 
            <strong style="color:#b0ba34;">₹599 / 45 Days</strong>
          </h5>

          <!-- Discounted Price -->
          <!--<h6 class="mb-3">-->
          <!--  <span style="color:#6c757d; text-decoration: line-through;">₹599</span>-->
          <!--  <span style="color:#28a745; font-weight:600;"> ₹499 / 45 Days (17% Off)</span>-->
          <!--</h6>-->

          <p style="color:#0a0a0a;">
            Perfect for individuals who want personal care and digital health support.
          </p>
      ...
      <div class="col-lg-6">
        <div class="plan-right p-4 h-100" 
          ...
          <!-- Price & Duration -->
           <h3 class="fw-bold" style="color:#b7c237;">₹599 <span style="font-size:18px;">/ 45 Days</span></h3>
...
                            <li><strong>Doctor Consultations:</strong> Unlimited online consultations</li>
                            <li><strong>Health Records:</strong> Personal digital health record storage</li>
                            <li><strong>Appointment Booking:</strong> Standard booking access</li>
                            <li><strong>Priority Support:</strong> Skip-the-line support for urgent needs</li>
                            <li><strong>Extra Value:</strong> Exclusive discounts on lab tests & medicines</li>
                        </ul>
                        <small style="color:#c8d439;">Guaranteed renewal available.</small>
                    </div>
          ...
          <div class="d-flex gap-3 my-3">
            ...
            <a href="#" 
                ...
                data-plan='{
                    ...
                    "members": "1",
                    "duration": "45 Days",
                    "features": ["Unlimited consultations", "Health records management", "Appointment booking", "Priority Support"]
                }'>
                Get Started – Individual Plan
            </a>
          </div>
