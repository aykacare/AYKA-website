...
<!-- End Google Tag Manager (noscript) -->
                ...
                <div class="col-lg-6">
                    ...
                    <div class="hero-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="text-anime-style-3" data-cursor="-opaque">Online Doctor Consultation India | Telemedicine & Video Visits
                            </h2>
                            <p class="wow fadeInUp" data-wow-delay="0.2s">Book online doctor consultations in India with verified physicians and specialists. Get video, chat, or phone consultations, digital prescriptions, and follow-ups — anytime, anywhere.</p>
                        </div>
                        <!-- Section Title End -->

                        <!-- Hero Buttons Start -->
                        <div class="hero-btn wow fadeInUp" data-wow-delay="0.4s">
                            <a href="https://expert.aykacare.in/?fluent-form=4" class="btn-default">book a appointment</a>
                        ...
                        <div class="about-us-body">
                            ...
                            <div class="about-info-item wow fadeInUp">
                                ...
                                <div class="about-info-item-content">
                                    ...
                                    <p>AYKA Care offers reliable online doctor consultations in India, connecting you with qualified general physicians and medical specialists via video, chat, or phone. Whether it’s everyday health concerns, specialist advice, or follow-up care, our telemedicine platform makes expert healthcare accessible wherever you are.</p>
                                </div>
                            </div>
                            <!-- About Info Item End -->
                            ...
                            <div class="about-info-item wow fadeInUp" data-wow-delay="0.25s">
                                ...
                                <div class="about-info-item-content">
                                    ...
                                    <p>Online doctor consultation lets you speak with a doctor through video call, phone call, or secure chat from your mobile or computer. This modern telemedicine approach helps you get medical advice, diagnosis, and digital prescriptions without traveling to a clinic or hospital.</p>
                                </div>
                            </div>
                            <!-- About Info Item End -->
    ...
    "features": [
        "Trusted & Verified Expert Doctors",
        "Your Privacy, Fully Protected",
        "Free Post-Consultation Follow-Up",
        "Quick Digital Prescriptions",
        "Safely Stored Health Records"
    ]
}
' >
            ...
            <div class="row section-row align-items-center">
                ...
                <div class="col-lg-5">
                    ...
                    <div class="why-choose-list wow fadeInUp">
                        <ul>
                            <li><h3>Search for a Doctor
</h3> Choose from a list of specialist and general physicians.
</li>
                            <li><h3>Book Your Appointment
</h3> Select a time that works for you and confirm your consultation.
</li>
                            <li><h3>Consult via Video/Chat/Phone
</h3> Connect with the doctor from the comfort of your home.
</li>
                            <li><h3>Receive Your Prescription Online
</h3> Download your e-prescription and manage health records conveniently.</li>
...
<div class="image-container" 
     style="flex: 0 0 450px; height: 600px; position: relative; border-radius: 15px; 
            overflow: hidden; display:flex; align-items:center; justify-content:center;">
    
    <img src="./assets/images/ayka-ai-doc.jpg" 
                        ...
                        <div class="col-lg-6">
                            <div class="our-faqs-content">
                                ...
                                <div class="faq-cta-box wow fadeInUp" data-wow-delay="0.5s">
                                    <div class="icon-box">
                                        <img src="./assets/images/icon-faq-cta.svg" alt="" style="filter: invert(75%) sepia(26%) saturate(1500%) hue-rotate(28deg) brightness(95%) contrast(90%);">
                                    </div>
    ...
    <div class="testimonial-wrapper">
        ...
        <div class="testimonial-container">
            <div class="testimonial-card">
                ...
                <p class="testimonial-text">“I was impressed with the professionalism of the doctors. The whole process felt very secure.”</p>
            ...
            <div class="testimonial-card">
                ...
                <p class="testimonial-text">“Excellent platform! AYKA Care gave me confidence in accessing healthcare from home.”</p>
            ...
            <div class="testimonial-card">
                ...
                <p class="testimonial-text">“From booking to consultation, everything was simple and smooth. AYKA Care really delivers quality.”</p>
            ...
            <div class="testimonial-card">
                ...
                <p class="testimonial-text">“AYKA Care made it so easy to get a second opinion without any hassle. Thank you for the support!”</p>
            ...
            <div class="testimonial-card">
                ...
                <p class="testimonial-text">“Acne lowered my confidence, but AYKA Care connected me with a dermatologist who treated me quickly. Trusted advice, real results, and smooth experience. A true blessing for women!”</p>
              ...
              <div class="testimonial-card">
                ...
                <p class="testimonial-text">“When my son had sudden fever at night, AYKA Care instantly connected me with a pediatrician. The doctor guided us and even arranged a clinic visit. Truly stress-free.”</p>
...
<script>
    ...
    <div class="d-flex align-items-center mb-4">
        <img src="./assets/images/logo-2.png" alt="AYKA Care Logo" class="me-2" style="height:40px;">
        <h5 class="fw-bold mb-0">AYKA CARE</h5>
    </div>

    <h4 class="fw-bold mb-3" id="planTitle">Health Consultation</h4>

    <ol class="mb-4 ps-3" id="planFeatures">
        <li>Describe your symptoms clearly</li>
        <li>Share patient details for accurate diagnosis</li>
        <li>Our medical team will contact you shortly</li>
    </ol>
    ...
    <div class="mt-4">
        ...
        <p class="small text-muted">
            By proceeding, you agree to share the information provided on this page with AYKA CARE for medical assistance,
            in compliance with applicable laws and privacy standards.
        </p>
        <a href="#" class="small text-decoration-none">View Business Policies</a>
    </div>
</div>
    ...
    <div class="col-12">
        ...
        <textarea name="symptoms_details" class="form-control" placeholder="Describe symptoms..." required></textarea>
    </div>
    ...
    <div class="col-12">
        ...
        <textarea name="concern" class="form-control" placeholder="Explain your concern..." required></textarea>
    </div>
...
<style>
    ...
    @keyframes pulse {
        ...
        <script>window.$zoho=window.$zoho || {};$zoho.salesiq=$zoho.salesiq||{ready:function(){}}</script><script id="zsiqscript" src="https://salesiq.zohopublic.in/widget?wc=siqb0f830a0885067d021d45d0a48528e2d255c3bf6ab1e64226805d95539ae3b1a" defer></script>
