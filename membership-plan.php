...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['name']) && !isset($_POST['razorpay_payment_id'])) {
    ...
    $totalRupees = floatval($form['TotalPaybleAmount']);          // e.g. 672.82
  ...
  <div class="topbar">
    ...
    <div class="page-header bg-section">
        <div class="container">
            ...
            <p class="mb-3 fs-6">Sign up now and enjoy <strong>upto 25% OFF</strong> on our Premium Membership Plan.</p>
             <a href="https://rzp.io/rzp/mjVqA0Na" 
    ...
    <!-- Dental Health Plan Section Start -->
    <section class="dental-plan py-5">
        <div class="container">
            <div class="row align-items-center">
    ...
    <div class="plan-left p-4 h-100"
        ...
        <h4 class="fw-bold" style="color:#b7c237;">Senior Care Health Plan</h4>
        <h5 class="mb-3">
            Unbelievable But True <span style="color:#c8d439;">Senior Care</span> only at
            <strong style="color:#b0ba34;">₹649</strong>
        </h5>

        <!-- Discounted Price -->
        <!--<h6 class="mb-3">-->
        <!--    <span style="color:#6c757d; text-decoration: line-through;">₹649</span>-->
        <!--    <span style="color:#28a745; font-weight:600;"> ₹549 (15% Off)</span>-->
        <!--</h6>-->

        <img src="./assets/images/family2.webp" class="img-fluid mt-3 rounded" alt="Dental Care">
    </div>
</div>
                ...
                <div class="col-lg-6">
                    <div class="plan-right p-4 h-100"
                        style="background:#ffffff; border:1px solid #eff0ef; border-radius:8px;">
                        <h3 class="fw-bold" style="color:#b7c237;">Senior Care Health Plan</h3>
                        <h4 class="fw-bold mt-3" style="color:#b0ba34;">₹649.00</h4>
                        <p style="color:#090a0a;">Exclusive of all taxes</p>

                        <!-- Buttons -->
                        <div class="d-flex gap-3 my-3">
                            <!--<a href="https://wa.me/919220782066?text=Hi%20I%20need%20help" class="btn px-4" style="border:1px solid #0a0a0a; color:#0a0a0a;">Request A-->
                            <!--    Callback</a>-->
                            <a href="#" 
                                ...
                                data-plan='{
                                    ...
                                    "members": "1",
                                    "duration": "45 Days",
                                    "features": ["Unlimited consultations", "Prescription tracking", "Appointment booking"]
                                }'>
                                Get Started
                            </a>
                        </div>
...
                            <h6 class="fw-bold" style="color:#b7c237;">Exclusions</h6>
                            <ul class="mb-2" style="color:#0e0e0e;">
                                <li>Unlimited consultations with priority access</li>
                                <li>Dedicated prescription tracking for seniors</li>
                                <li>Instant appointment booking</li>
                                <li>Senior-focused support & reminders</li>
                                <li>Regular health check reminders for ongoing care</li>
                            </ul>
                            <small style="color:#c8d439;">Guaranteed lifetime renewal option.</small>
                        </div>
                            ...
                            <div class="faq-accordion" id="faqaccordion">
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                                    <h2 class="accordion-header" id="heading6">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            ...
                                            ⁠⁠Who can enroll under the Senior Care Health Plan?
                                        </button>
                                    </h2>
                                    <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="heading6"
                                        data-bs-parent="#faqaccordion">
                                        <div class="accordion-body">
                                            <p>Individuals aged 50 years and above can enroll in this plan.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- FAQ Item End -->
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                                    <h2 class="accordion-header" id="heading6">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
                                            ⁠⁠How many consultations are included in Senior Care Health Plan?
                                        </button>
                                    </h2>
                                    <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="heading6"
                                        data-bs-parent="#faqaccordion">
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                                    <h2 class="accordion-header" id="heading6">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
                                            ⁠Does Senior Care Health Plan include home visit services?
                                        </button>
                                    </h2>
                                    <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="heading6"
                                        data-bs-parent="#faqaccordion">
                                        <div class="accordion-body">
                                            <p>Currently, consultations are online only. However, home care may be introduced in future updates.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- FAQ Item End -->
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                                    <h2 class="accordion-header" id="heading6">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
                                            ⁠Can family members monitor the senior’s consultations?
                                        </button>
                                    </h2>
                                    <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="heading6"
                                        data-bs-parent="#faqaccordion">
                                        <div class="accordion-body">
                                            <p>Yes, a family member can be added as a care contact to assist with booking and follow-up.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- FAQ Item End -->
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                                    <h2 class="accordion-header" id="heading6">
                                        <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                            data-bs-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
                                            ⁠⁠Are reminders and prescriptions digital?
                                        </button>
                                    </h2>
                                    <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="heading6"
                                        data-bs-parent="#faqaccordion">
                                        <div class="accordion-body">
                                            <p>Yes, all reminders and prescriptions are managed through the AYKA Care App.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- FAQ Item End -->
                                ...
                                <div class="accordion-item wow fadeInUp" data-wow-delay="1s">
                                    ...
                                    <div id="collapse6" class="accordion-collapse collapse" aria-labelledby="heading6"
                                        data-bs-parent="#faqaccordion">
                                        <div class="accordion-body">
                                            <p>The plan expires automatically but can be renewed instantly for continued care.</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- FAQ Item End -->
